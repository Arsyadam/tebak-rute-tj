...
export const gameHud = {
  ...
  /** Timer / countdown — yellow, flat (no glow shadow) */
  timer:
    'inline-flex min-w-[5.5rem] items-center justify-center rounded-2xl bg-[#F9A01B] px-5 py-2.5 font-display text-lg font-bold tabular-nums text-[#003324]',
  /** Urgent countdown under 10s — safety red #E4002B */
  timerDanger:
    'inline-flex min-w-[5.5rem] items-center justify-center rounded-2xl bg-[#E4002B] px-5 py-2.5 font-display text-lg font-bold tabular-nums text-white',
  accent: 'text-[#FF6B00]',
  ...
  submit:
    'h-12 rounded-xl border border-[rgba(18,69,43,0.16)] bg-white px-5 font-bold text-[#003324] hover:bg-[#EBF4F9]',
  iconBtn:
    'size-10 shrink-0 rounded-xl border border-[rgba(18,69,43,0.12)] bg-white text-[#003324] hover:bg-[#EBF4F9]',
  badge:
  ...
  progressTrack: 'h-1.5 overflow-hidden rounded-full bg-[#EBF4F9]',
